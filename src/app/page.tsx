...
{/* LOGO STRIP - TEXT ONLY INTEGRATIONS */}
        <section className="w-full py-12 border-y border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-white/[0.02] transition-colors duration-300">
          <div className="container px-4 md:px-6 mx-auto">
            ...
            {/* Using flex and gap to control spacing, no icons/div wrappers */}
            <div className="flex flex-wrap justify-center items-center gap-x-10 gap-y-4 md:gap-x-16 md:gap-y-6 grayscale opacity-70 dark:opacity-60">
